...
$.ajax({
    ...
    function showresult(result){
        ...
        var text6_h = document.createTextNode(result.sixth.title);
        var text6_p = document.createTextNode(result.sixth.content);
        ...
        var text7_h = document.createTextNode(result.seventh.title);
        var text7_p = document.createTextNode(result.seventh.content);
        ...
        var text8_h = document.createTextNode(result.eighth.title);
        var text8_p = document.createTextNode(result.eighth.content);
        ...
        var text9_h = document.createTextNode(result.ninth.title);
        var text9_p = document.createTextNode(result.ninth.content);
        ...
        var text10_h = document.createTextNode(result.tenth.title);
        var text10_p = document.createTextNode(result.tenth.content);
